...
class Mouse(object):
 ...
 # setup object
    ...
    # direct mouse move or button press
    def move(self, x, y):
        self.direct_mouse(x, y)

    def lb_press(self):
        self.direct_mouse(buttons=Mouse.mouse_lb_press)

    def lb_release(self):
        self.direct_mouse(buttons=Mouse.mouse_lb_release)

    def rb_press(self):
        self.keys_worker.sendMouse(0, 0, mouse_rb_release)
        # self.move(buttons=mouse_rb_press)

    def rb_release(self):
        self.move(buttons=mouse_rb_release)

    def get_position(self):
        # pt = [("x", ctypes.c_ulong), ("y", ctypes.c_ulong)]
        pt = POINT()
